...
def get_config():
    ...
    parser.add_argument("--env", type=str, default=env, help="Gym environment name, default: CartPole-v0")
...
def train(config):
    ...
    with wandb.init(project="SAC_Discrete", name=config.run_name, config=config):
        ...
        agent = SAC(state_size=15, action_size=env.action_space.shape[0], device=device)
